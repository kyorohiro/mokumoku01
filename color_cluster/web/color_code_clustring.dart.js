...
(function dartProgram() {
  ...
  Z.main_closure0.prototype = {
    call$1: function(message) {
      var colorsSrc, colors, code, red, green, blue, clusterList, pickupColors, cs, r, g, b, c, t3, hierarchical, _i, t4, t5, exception,
        _s11_ = "postMessage",
        t1 = type$.MessageEvent._as(message).data,
      ...
      try {
        ...
        t1 = type$.JSArray_int;
        hierarchical = new E.Hierarchical(H.setRuntimeTypeInfo([], t1), H.setRuntimeTypeInfo([], t1), 10, C.LINKAGE_0, H.setRuntimeTypeInfo([], type$.JSArray_List_int), P.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.double));
        switch (C.LINKAGE_0) {
          case C.LINKAGE_2:
        ...
        clusterList = hierarchical.run$1(type$.List_List_double._as(colors));
        pickupColors = H.setRuntimeTypeInfo([], t1);
        for (t1 = clusterList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          ...
          t4 = H._asIntNullable(r);
          t3 = H._asIntNullable(g);
          t5 = H._asIntNullable(b);
          if (typeof t4 !== "number")
            return t4.$shl();
          if (typeof t3 !== "number")
            return t3.$shl();
          if (typeof t5 !== "number")
            return t5.$shl();
          J.add$1$ax(pickupColors, (4278190080 | t4 << 16 & 16711680 | t3 << 8 & 65280 | t5 << 0 & 255) >>> 0);
        }
...
//# sourceMappingURL=color_code_clustring.dart.js.map
