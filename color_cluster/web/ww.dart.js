...
(function dartProgram() {
  ...
  J = {
    ...
    reduce$1$ax: function(receiver, a0) {
  ...
  P = {
    ...
    min: function(a, b, $T) {
      H.checkTypeBound($T, type$.num, "T", "min");
      $T._as(a);
      $T._as(b);
  ...
  E = {LINKAGE: function LINKAGE(t0) {
      this._hierarchical$_name = t0;
    }, Level: function Level(t0) {
      this.linkage = t0;
    }, MinLinkage: function MinLinkage(t0, t1, t2) {
      this.linkage = t0;
      this.i = t1;
      this.j = t2;
    }, Hierarchical: function Hierarchical(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._level = _.dataset = null;
      _._noise = t0;
      _._label = t1;
      _.minCluster = t2;
      _.linkage = t3;
      _._distanceMatrix = _.linkageMeasure = null;
      _._cluster = t4;
      _._cache = t5;
    }, Hierarchical_run_closure: function Hierarchical_run_closure() {
    }, Hierarchical_mergeCluster_closure: function Hierarchical_mergeCluster_closure() {
    }, Hierarchical_mergeCluster__closure: function Hierarchical_mergeCluster__closure() {
    }, Hierarchical_averageLink_closure: function Hierarchical_averageLink_closure() {
    }},
  Z = {
    callbackToStream: function($name, unwrapValue, $J, $T) {
      var t1 = $T._eval$1("_SyncBroadcastStreamController<0>"),
        controller = new P._SyncBroadcastStreamController(null, null, t1);
      $.$get$_context().$index(0, "self")[$name] = P.allowInterop(new Z.callbackToStream_closure(controller, unwrapValue, $J), $J._eval$1("Null(0)"));
      return new P._BroadcastStream(controller, t1._eval$1("_BroadcastStream<1>"));
    },
    ARGB_argb: function(a, r, g, b) {
      return (0 | a << 24 & 4278190080 | r << 16 & 16711680 | g << 8 & 65280 | b << 0 & 255) >>> 0;
    },
    main: function() {
      var t1 = type$.MessageEvent;
      Z.callbackToStream("onmessage", new Z.main_closure(), t1, t1).listen$1(new Z.main_closure0());
    },
  ...
  R = {
    euclideanDistance: function(point1, point2) {
      var t2, loop, sum, i, t3, t4, t5, t6,
        t1 = type$.List_double;
      t1._as(point1);
      t1._as(point2);
      t1 = J.getInterceptor$asx(point1);
      t2 = J.getInterceptor$asx(point2);
      loop = Math.min(t1.get$length(point1), t2.get$length(point2));
      for (sum = 0, i = 0; i < loop; ++i) {
        t3 = t1.$index(point1, i);
        t4 = t2.$index(point2, i);
        if (typeof t3 !== "number")
          return t3.$sub();
        if (typeof t4 !== "number")
          return H.iae(t4);
        t5 = t1.$index(point1, i);
        t6 = t2.$index(point2, i);
        if (typeof t5 !== "number")
          return t5.$sub();
        if (typeof t6 !== "number")
          return H.iae(t6);
  ...
  H.ListIterable.prototype = {
    ...
    toList$0: function(_) {
      var t3, i,
        result = H.setRuntimeTypeInfo([], this.$ti._eval$1("JSArray<ListIterable.E>")),
        t1 = this._source,
        t2 = J.getInterceptor$asx(t1);
      C.JSArray_methods.set$length(result, t2.get$length(t1));
      for (t3 = this._f, i = 0; i < t2.get$length(t1); ++i)
        C.JSArray_methods.$indexSet(result, i, t3.call$1(t2.elementAt$1(t1, i)));
      return result;
    }
  };
  ...
  P._BroadcastSubscription.prototype = {
    ...
    set$_previous: function(_previous) {
      this._previous = this.$ti._as(_previous);
    }
  };
  ...
  P._BufferingStreamSubscription.prototype = {
    _BufferingStreamSubscription$4: function(onData, onError, onDone, cancelOnError, $T) {
      var handleError, _this = this,
        t1 = H._instanceType(_this);
      t1._eval$1("~(1)")._as(onData);
      _this.set$_onData(type$.$env_1_1_dynamic._bind$1(t1._precomputed1)._eval$1("1(2)")._as(onData));
      handleError = onError == null ? P.async___nullErrorHandler$closure() : onError;
      if (type$.void_Function_Object_StackTrace._is(handleError))
        _this._zone.registerBinaryCallback$3$1(handleError, type$.dynamic, type$.Object, type$.StackTrace);
      else if (type$.void_Function_Object._is(handleError))
        type$.dynamic_Function_Object._as(handleError);
      else
    ...
    set$_onDone: function(_onDone) {
      type$.void_Function._as(_onDone);
    },
  ...
  P._PendingEvents_schedule_closure.prototype = {
    call$0: function() {
      ...
      H._instanceType($event)._eval$1("_EventDispatch<1>")._as(t2)._sendData$1($event.value);
    },
    $signature: 0
  };
  ...
  P.ListMixin.prototype = {
    ...
    reduce$1: function(receiver, combine) {
      ...
      H.instanceType(receiver)._eval$1("ListMixin.E(ListMixin.E,ListMixin.E)")._as(combine);
  ...
  P.JsObject.prototype = {
    ...
    callMethod$2: function(method, args) {
      ...
      if (args == null)
        ...
        t2 = type$.dynamic;
        t2 = P.List_List$from(J.map$1$1$ax(args, P.js___convertToJS$closure(), t2), true, t2);
      }
  ...
  P.JsArray.prototype = {
    ...
    addAll$1: function(_, iterable) {
      ...
      this.callMethod$2("push", iterable instanceof Array ? iterable : P.List_List$from(iterable, true, type$.dynamic));
    },
    $isIterable: 1,
    $isList: 1
  };
  ...
  E.LINKAGE.prototype = {
    toString$0: function(_) {
      return this._hierarchical$_name;
    }
  };
  E.Level.prototype = {};
  E.MinLinkage.prototype = {};
  E.Hierarchical.prototype = {
    run$1: function(dataset) {
      var t1, i, currentLevel, t2, t3, currentLabel, j, _this = this;
      type$.List_List_double._as(dataset);
      _this.set$dataset(0, dataset);
      _this.buildDistanceMatrix$0();
      _this.set$_cache(P.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.double));
      _this.set$_cluster(H.setRuntimeTypeInfo([], type$.JSArray_List_int));
      for (t1 = type$.JSArray_int, i = 0; i < dataset.length; ++i)
        C.JSArray_methods.add$1(_this._cluster, H.setRuntimeTypeInfo([i], t1));
      currentLevel = new E.Level(0);
      _this.set$_level(H.setRuntimeTypeInfo([currentLevel], type$.JSArray_Level));
      t2 = _this.minCluster;
      while (true) {
        if (_this._cluster.length > t2) {
          t3 = currentLevel.linkage;
          if (typeof t3 !== "number")
            return t3.$lt();
          t3 = t3 < 1 / 0;
        } else
        ...
        if (!t3)
          break;
        currentLevel = _this.mergeCluster$0();
      }
      _this.set$_label(P.List_List$generate(dataset.length, new E.Hierarchical_run_closure(), type$.int));
      _this.set$_noise(H.setRuntimeTypeInfo([], t1));
      for (currentLabel = 0, i = 0; t1 = _this._cluster, i < t1.length; ++i)
        if (J.get$length$asx(t1[i]) > 1) {
          j = 0;
          while (true) {
            t1 = _this._cluster;
            if (i >= t1.length)
              return H.ioore(t1, i);
            if (!(j < J.get$length$asx(t1[i])))
              break;
            t1 = _this._label;
            t2 = _this._cluster;
            if (i >= t2.length)
              return H.ioore(t2, i);
            C.JSArray_methods.$indexSet(t1, J.$index$asx(t2[i], j), currentLabel);
            ++j;
          }
          ++currentLabel;
        } else {
          ...
          if (i >= t2.length)
            return H.ioore(t2, i);
          C.JSArray_methods.add$1(t1, J.$index$asx(t2[i], 0));
        }
      return t1;
    },
    mergeCluster$0: function() {
      var min, i, t1, j, t2, t3, linkage, cluster, currentLevel, _this = this;
      for (min = null, i = 0; t1 = _this._cluster, i < t1.length; ++i)
        for (j = 0; j < i; ++j) {
          t1 = _this._cluster;
          t2 = t1.length;
          if (i >= t2)
          ...
          if (j >= t2)
            return H.ioore(t1, j);
          linkage = _this.getLinkage$2(t3, t1[j]);
          if (min != null) {
            t1 = min.linkage;
            ...
            t1 = true;
          if (t1)
            min = new E.MinLinkage(linkage, i, j);
        }
      t2 = H._arrayInstanceType(t1);
      cluster = new H.MappedListIterable(t1, t2._eval$1("List<int>(1)")._as(new E.Hierarchical_mergeCluster_closure()), t2._eval$1("MappedListIterable<1,List<int>>")).toList$0(0);
      t2 = min.i;
      t1 = cluster.length;
      if (t2 >= t1)
        return H.ioore(cluster, t2);
      t2 = cluster[t2];
      t3 = min.j;
      if (t3 >= t1)
        return H.ioore(cluster, t3);
      J.addAll$1$ax(t2, cluster[t3]);
      if (!!cluster.fixed$length)
        H.throwExpression(P.UnsupportedError$("removeAt"));
      t1 = cluster.length;
      if (t3 >= t1)
        H.throwExpression(P.RangeError$value(t3, null));
      cluster.splice(t3, 1)[0];
      currentLevel = new E.Level(min.linkage);
      t1 = _this._level;
      (t1 && C.JSArray_methods).add$1(t1, currentLevel);
      _this.set$_cluster(cluster);
      return currentLevel;
    },
    getLinkage$2: function(cluster1, cluster2) {
      var t2, hash, distanceList, i, j, _this = this,
        t1 = type$.List_int;
      t1._as(cluster1);
      t1._as(cluster2);
      t1 = J.getInterceptor$asx(cluster1);
      t2 = J.getInterceptor$asx(cluster2);
      hash = t1.get$length(cluster1) > t2.get$length(cluster2) ? H.S(cluster1) + "-" + H.S(cluster2) : H.S(cluster2) + "-" + H.S(cluster1);
      if (_this._cache.containsKey$1(hash))
        return _this._cache.$index(0, hash);
      distanceList = H.setRuntimeTypeInfo([], type$.JSArray_double);
      for (i = 0; i < t1.get$length(cluster1); ++i)
        for (j = 0; j < t2.get$length(cluster2); ++j)
          C.JSArray_methods.add$1(distanceList, _this.getDistance$2(t1.$index(cluster1, i), t2.$index(cluster2, j)));
      t1 = _this._cache;
      t2 = _this.linkageMeasure.call$1(distanceList);
      t1.$indexSet(0, hash, t2);
      return t2;
    },
    getDistance$2: function(i, j) {
      var t1;
      if (typeof i !== "number")
        return i.$gt();
      if (typeof j !== "number")
    ...
    buildDistanceMatrix$0: function() {
      var t1, i, vector, j, t2, t3, t4,
        matrix2d = H.setRuntimeTypeInfo([], type$.JSArray_List_double);
      for (t1 = type$.JSArray_double, i = 0; i < this.dataset.length; ++i) {
        vector = H.setRuntimeTypeInfo([], t1);
        for (j = 0; j < i; ++j) {
          t2 = this.dataset;
          t3 = t2.length;
          if (i >= t3)
          ...
          if (j >= t3)
            return H.ioore(t2, j);
          C.JSArray_methods.add$1(vector, R.euclideanDistance(t4, t2[j]));
        }
        C.JSArray_methods.add$1(matrix2d, vector);
      }
      this.set$_distanceMatrix(matrix2d);
    },
    singleLink$1: function(distanceList) {
      return J.reduce$1$ax(type$.List_double._as(distanceList), H.instantiate1(P.math__min$closure(), type$.double));
    },
    completeLink$1: function(distanceList) {
      return J.reduce$1$ax(type$.List_double._as(distanceList), H.instantiate1(P.math__max$closure(), type$.double));
    },
    averageLink$1: function(distanceList) {
      var t1, sum;
      type$.List_double._as(distanceList);
      t1 = J.getInterceptor$ax(distanceList);
      sum = t1.reduce$1(distanceList, new E.Hierarchical_averageLink_closure());
      t1 = t1.get$length(distanceList);
      if (typeof sum !== "number")
        return sum.$div();
      return sum / t1;
    },
    set$dataset: function(_, dataset) {
      this.dataset = type$.List_List_double._as(dataset);
    },
    set$_level: function(_level) {
      this._level = type$.List_Level._as(_level);
    },
    set$_noise: function(_noise) {
      this._noise = type$.List_int._as(_noise);
    },
    set$_label: function(_label) {
      this._label = type$.List_int._as(_label);
    },
    set$linkageMeasure: function(linkageMeasure) {
      this.linkageMeasure = type$.double_Function_List_double._as(linkageMeasure);
    },
    set$_distanceMatrix: function(_distanceMatrix) {
      this._distanceMatrix = type$.List_List_double._as(_distanceMatrix);
    },
    set$_cluster: function(_cluster) {
      this._cluster = type$.List_List_int._as(_cluster);
    },
    set$_cache: function(_cache) {
      this._cache = type$.Map_String_double._as(_cache);
    }
  };
  E.Hierarchical_run_closure.prototype = {
    call$1: function(_) {
      return -1;
    },
    $signature: 8
  };
  E.Hierarchical_mergeCluster_closure.prototype = {
    call$1: function(oneClus) {
      return J.map$1$1$ax(type$.List_int._as(oneClus), new E.Hierarchical_mergeCluster__closure(), type$.int).toList$0(0);
    },
    $signature: 21
  };
  E.Hierarchical_mergeCluster__closure.prototype = {
    call$1: function(index) {
      return H._asIntNullable(index);
    },
    $signature: 8
  };
  E.Hierarchical_averageLink_closure.prototype = {
    call$2: function(a, b) {
      H._asDoubleNullable(a);
      H._asDoubleNullable(b);
      if (typeof a !== "number")
        return a.$add();
      if (typeof b !== "number")
        return H.iae(b);
  ...
  Z.callbackToStream_closure.prototype = {
    call$1: function($event) {
      var t1 = this.controller,
        t2 = H._instanceType(t1)._precomputed1._as(this.unwrapValue.call$1(this.J._as($event)));
  ...
  Z.main_closure.prototype = {
    call$1: function(e) {
      return type$.MessageEvent._as(e);
    },
    $signature: 23
  };
  Z.main_closure0.prototype = {
    call$1: function(message) {
      var colorsSrc, colors, code, red, green, blue, clusterList, pickupColors, cs, r, g, b, c, e, t1, t2, t3, hierarchical, clusterList0, _i, t4, t5, exception,
        _s11_ = "postMessage";
      ...
      t2.mustCopy = true;
      colorsSrc = type$.List_dynamic._as(t2.walk$1(t1));
      colors = H.setRuntimeTypeInfo([], type$.JSArray_List_double);
      try {
        for (t1 = J.get$iterator$ax(colorsSrc), t2 = type$.JSArray_double; t1.moveNext$0();) {
          code = t1.get$current();
          t3 = H._asIntNullable(code);
          if (typeof t3 !== "number")
            return H.iae(t3);
          t3 = H._asIntNullable(code);
          if (typeof t3 !== "number")
          ...
          if (typeof t3 !== "number")
            return H.iae(t3);
          blue = (255 & t3) >>> 0;
          J.add$1$ax(colors, H.setRuntimeTypeInfo([red, green, blue], t2));
        }
        t1 = colors;
        P.print("Hello, World!! " + J.get$length$asx(t1));
        t2 = type$.JSArray_int;
        hierarchical = new E.Hierarchical(H.setRuntimeTypeInfo([], t2), H.setRuntimeTypeInfo([], t2), 10, C.LINKAGE_0, H.setRuntimeTypeInfo([], type$.JSArray_List_int), P.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.double));
        switch (C.LINKAGE_0) {
          case C.LINKAGE_2:
            hierarchical.set$linkageMeasure(hierarchical.get$averageLink());
            break;
          case C.LINKAGE_1:
            hierarchical.set$linkageMeasure(hierarchical.get$completeLink());
            break;
          case C.LINKAGE_0:
            hierarchical.set$linkageMeasure(hierarchical.get$singleLink());
            break;
        }
        P.print("Hello, World!!");
        clusterList0 = hierarchical.run$1(type$.List_List_double._as(t1));
        P.print("===== 1 =====");
        P.print("Clusters output");
        P.print(clusterList0);
        P.print("Noise");
        P.print(hierarchical._noise);
        P.print("Cluster label for points");
        P.print(hierarchical._label);
        clusterList = clusterList0;
        pickupColors = H.setRuntimeTypeInfo([], t2);
        for (t1 = clusterList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          cs = t1[_i];
          r = 0;
          g = 0;
          b = 0;
          for (t3 = J.get$iterator$ax(cs); t3.moveNext$0();) {
            c = t3.get$current();
            t4 = r;
            t5 = J.$index$asx(colors, c);
            if (0 >= t5.length)
              return H.ioore(t5, 0);
            t5 = t5[0];
            if (typeof t4 !== "number")
          ...
          t3 = r;
          t4 = J.get$length$asx(cs);
          if (typeof t3 !== "number")
            return t3.$tdiv();
          r = C.JSNumber_methods.$tdiv(t3, t4);
          t4 = g;
          t3 = J.get$length$asx(cs);
          if (typeof t4 !== "number")
            return t4.$tdiv();
          g = C.JSNumber_methods.$tdiv(t4, t3);
          t3 = b;
          t4 = J.get$length$asx(cs);
          if (typeof t3 !== "number")
            return t3.$tdiv();
          b = C.JSNumber_methods.$tdiv(t3, t4);
          H.printString(">> " + Z.ARGB_argb(255, H._asIntNullable(r), H._asIntNullable(g), H._asIntNullable(b)) + " " + H.S(r) + " " + H.S(g) + " " + H.S(b));
          J.add$1$ax(pickupColors, Z.ARGB_argb(255, H._asIntNullable(r), H._asIntNullable(g), H._asIntNullable(b)));
        }
        P.print(">==>>> " + H.S(pickupColors));
        $.$get$_context().callMethod$2(_s11_, [pickupColors]);
      } catch (exception) {
        e = H.unwrapException(exception);
        P.print("yy:" + H.S(e));
        $.$get$_context().callMethod$2(_s11_, ["error"]);
      }
    },
    $signature: 24
  };
  ...
  (function installTearOffs() {
    ...
    _instance(P._Future.prototype, "get$_completeError", 0, 1, null, ["call$2", "call$1"], ["_completeError$2", "_completeError$1"], 6, 0);
    ...
    var _;
    _instance_1_u(_ = E.Hierarchical.prototype, "get$singleLink", "singleLink$1", 3);
    _instance_1_u(_, "get$completeLink", "completeLink$1", 3);
    _instance_1_u(_, "get$averageLink", "averageLink$1", 3);
    ...
    _static_2(R, "common__euclideanDistance$closure", "euclideanDistance", 28);
  })();
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Iterable, H.ListIterator, H.FixedLengthListMixin, H.Symbol, P.MapView, H.ConstantMap, H.Closure, H.JSInvocationMirror, H.TypeErrorDecoder, P.Error, H._StackTrace, P.MapMixin, H.LinkedHashMapCell, H.Rti, H._FunctionParameters, H._Type, P._TimerImpl, P.Stream, P._BufferingStreamSubscription, P._BroadcastStreamController, P._Completer, P._FutureListener, P._Future, P._AsyncCallbackEntry, P._DelayedEvent, P._PendingEvents, P._DoneStreamSubscription, P.AsyncError, P._Zone, P.ListMixin, P._UnmodifiableMapMixin, P.bool, P.DateTime, P.num, P.StackOverflowError, P._Exception, P.Function, P.List, P.Null, P.StackTrace, P._StringStackTrace, P.String, P.StringBuffer, P.Symbol0, P._AcceptStructuredClone, P.JsObject, E.LINKAGE, E.Level, E.MinLinkage, E.Hierarchical]);
  ...
  var init = {
    ...
    metadata: [],
    types: ["Null()", "~()", "@(@)", "double(List<double>)", "~(~())", "Null(@)", "~(Object[StackTrace])", "~(@)", "int(int)", "Null(String,@)", "@(@,String)", "@(String)", "Null(~())", "Null(@[StackTrace])", "_Future<@>(@)", "Null(@,@)", "Null(Symbol0,@)", "@(@,@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "List<int>(List<int>)", "double(double,double)", "MessageEvent(MessageEvent)", "Null(MessageEvent)", "Object(@)", "0^(0^,0^)<num>", "0^(0^,0^)<num>", "double(List<double>,List<double>)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"Element","GraphicsElement":"Element","SvgElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","DedicatedWorkerGlobalScope":"WorkerGlobalScope","CDataSection":"CharacterData","Text":"CharacterData","File":"Blob","NativeFloat32List":"NativeTypedArrayOfDouble","NativeByteData":"NativeTypedData","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"int":[],"double":[],"num":[]},"JSDouble":{"double":[],"num":[]},"JSString":{"String":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"Symbol":{"Symbol0":[]},"ConstantMapView":{"UnmodifiableMapView":["1","2"],"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"Instantiation":{"Closure":[],"Function":[]},"Instantiation1":{"Closure":[],"Function":[]},"JSInvocationMirror":{"Invocation":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Closure":[],"Function":[]},"StaticClosure":{"Closure":[],"Function":[]},"BoundClosure":{"Closure":[],"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"Map":["1","2"]},"NativeTypedData":{"TypedData":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["@"],"TypedData":[]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["@"],"List":["double"],"FixedLengthListMixin":["double"],"TypedData":[],"Iterable":["double"],"ListMixin.E":"double","FixedLengthListMixin.E":"double"},"NativeTypedArrayOfInt":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"]},"NativeInt16List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"TypedData":[],"Iterable":["int"],"ListMixin.E":"int","FixedLengthListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_BroadcastStream":{"_ControllerStream":["1"],"_StreamImpl":["1"],"Stream":["1"]},"_BroadcastSubscription":{"_ControllerSubscription":["1"],"_BufferingStreamSubscription":["1"],"_EventDispatch":["1"],"StreamSubscription":["1"]},"_BroadcastStreamController":{"_EventDispatch":["1"],"_StreamControllerLifecycle":["1"]},"_SyncBroadcastStreamController":{"_BroadcastStreamController":["1"],"_EventDispatch":["1"],"_StreamControllerLifecycle":["1"]},"_AsyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"_ControllerStream":{"_StreamImpl":["1"],"Stream":["1"]},"_ControllerSubscription":{"_BufferingStreamSubscription":["1"],"_EventDispatch":["1"],"StreamSubscription":["1"]},"_BufferingStreamSubscription":{"_EventDispatch":["1"],"StreamSubscription":["1"]},"_StreamImpl":{"Stream":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_StreamImplEvents":{"_PendingEvents":["1"]},"_DoneStreamSubscription":{"StreamSubscription":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"Zone":[]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"double":{"num":[]},"AssertionError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"NoSuchMethodError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"int":{"num":[]},"List":{"Iterable":["1"]},"_StringStackTrace":{"StackTrace":[]},"HtmlElement":{"Node":[]},"AnchorElement":{"Node":[]},"AreaElement":{"Node":[]},"CharacterData":{"Node":[]},"Element":{"Node":[]},"FormElement":{"Node":[]},"MessageEvent":{"Event":[]},"SelectElement":{"Node":[]},"JsFunction":{"JsObject":[]},"JsArray":{"ListMixin":["1"],"List":["1"],"JsObject":[],"Iterable":["1"],"ListMixin.E":"1"}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"MapBase":2,"_JsArray_JsObject_ListMixin":1}'));
  var type$ = (function rtii() {
    ...
    return {
      ...
      List_Level: findType("List<Level>"),
      List_List_double: findType("List<List<double>>"),
      ...
      double_Function_List_double: findType("double(List<double>)"),
      dynamic: findType("@"),
...
;
    ...
    C.LINKAGE_0 = new E.LINKAGE("LINKAGE.SINGLE");
    C.LINKAGE_1 = new E.LINKAGE("LINKAGE.COMPLETE");
    C.LINKAGE_2 = new E.LINKAGE("LINKAGE.AVERAGE");
